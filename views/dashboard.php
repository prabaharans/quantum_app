...
<head>
    ...
    <meta name="description" content="QuantumPHP Studio: A high-performance, browser-based quantum circuit simulator powered by a PHP 8 statevector engine. Build, simulate, and visualize quantum circuits with 3D Bloch spheres and real-time step-by-step analysis.">
        ...
        <header class="app-header">
            <div class="brand">
                ...
                <div class="brand-text">
                    ...
                    <p>Advanced Quantum Simulator &amp; Visualizer (PHP 8.5 Backend · MVC Architecture)</p>
                </div>
            </div>
            <div class="header-controls">
                <span class="badge php-badge">PHP 8.5</span>
                <span class="badge webgl-badge">WebGL 3D</span>
                <span class="badge mvc-badge">MVC</span>
            </div>
        </header>
